 ...
 */
package net.dasnotsad.framework.elasticsearch.core.page.cache;
...
import net.dasnotsad.framework.elasticsearch.core.page.PagenationIdPair;
...
public class LocalMemoryPageCache implements IPageCache {

    /**
     * key:第n个10条，value:起始id对象
     */
    private Map<Integer, PagenationIdPair> idMaps = new HashMap<>();
    ...
    @Override
    public void saveQueryPage(int pageNo, PagenationIdPair idPair) {
    ...
    @Override
    public PagenationIdPair getIdPairFromQueryPage(int pageNo) {
    ...
    @Override
    public PageNoGroup getClosestFromTarget(int pageNo) {
        ...
        return new PageNoGroup(pageNo, pageNumStart, pageNumEnd);
    }
