 ...
 * @Author Created by yan.x on 2019-05-04 .
 * @Copyright dgg group.All Rights Reserved.
 **/
public final class DggHexUtil {
    ...
    public static char[] encodeHex(String str, Charset charset) {
        return encodeHex(DggStringUtil.bytes(str, charset), true);
    }
    ...
    public static String encodeHexStr(String data, Charset charset) {
        return encodeHexStr(DggStringUtil.bytes(data, charset), true);
    }
    ...
    public static String encodeHexStr(String data) {
        return encodeHexStr(data, DggCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr) {
        return decodeHexStr(hexStr, DggCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr, Charset charset) {
        if (DggStringUtil.isEmpty(hexStr)) {
            return hexStr;
        }
    ...
    public static String decodeHexStr(char[] hexData, Charset charset) {
        return DggStringUtil.toEncodedString(decodeHex(hexData), charset);
    }
