...
import net.dgg.utils.core.DggCharUtil;
...
public class DggNumberUtil {
    ...
    public static BigDecimal add(Number... values) {
        if (DggArrayUtil.isEmpty(values)) {
    ...
    public static BigDecimal div(BigDecimal v1, BigDecimal v2, int scale, RoundingMode roundingMode) {
        DggAsserts.isNotNull(v2, "Divisor must be not null !");
        if (null == v1) {
            return BigDecimal.ZERO;
        }
        if (scale < 0) {
    ...
    public static BigDecimal round(String numberStr, int scale, RoundingMode roundingMode) {
        DggAsserts.isNotBlank(numberStr);
        if (scale < 0) {
            scale = 0;
        }
    ...
    public static boolean isPrimes(int n) {
        DggAsserts.isTrue(n > 1, "The number must be > 1");
    ...
    public static boolean isGreater(BigDecimal bigNum1, BigDecimal bigNum2) {
        DggAsserts.isNotNull(bigNum1);
        DggAsserts.isNotNull(bigNum2);
     ...
     * @return 是否相同
     * @see DggCharUtils#equals(char, char, boolean)
     */
    public static boolean equals(char c1, char c2, boolean ignoreCase) {
        return DggCharUtil.equals(c1, c2, ignoreCase);
    }
     ...
     * @return 最小值
     * @see DggArrayUtil#min(Comparable[])
     */
    @SuppressWarnings("unchecked")
    public static <T extends Comparable<? super T>> T min(T... numberArray) {
        return DggArrayUtil.min(numberArray);
    }
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see DggArrayUtil#max(Comparable[])
     */
    @SuppressWarnings("unchecked")
    public static <T extends Comparable<? super T>> T max(T... numberArray) {
        return DggArrayUtil.max(numberArray);
    }
    ...
    public static String toStr(Number number) {
        ...
        if (false == DggObjectUtil.isValidIfNumber(number)) {
     ...
     * @deprecated 请使用{@link DggCharUtils#isBlankChar(char)}
     */
    @Deprecated
     ...
     * @see Character#isWhitespace(int)
     * @see Character#isSpaceChar(int)
     * @deprecated 请使用{@link DggCharUtils#isBlankChar(int)}
     */
    @Deprecated
    ...
    public static int parseInt(String number) throws NumberFormatException {
        ...
        // 对于带小数转换为整数采取去掉小数的策略
        number = StringUtils.substringBefore(number, ".");
    ...
    private static String removeNumberFlag(String number) {
        ...
        if ('D' == lastCharUpper || 'L' == lastCharUpper || 'F' == lastCharUpper) {
            number = StringUtils.left(number, lastPos);
        }
        return number;
    }
    // ------------------------------------------------------------------------------------------- Private method end
