...
/**
 * Describe: {@link ClassLoader}工具类
 * Created by yan.x on 2019-01-24 .
 **/
public final class DggClassLoaderUtil {
     ...
     * 2、获取{@link DggClassLoaderUtils}类对应的ClassLoader
    ...
    public static ClassLoader getClassLoader() {
        ...
        if (classLoader == null) {
            classLoader = DggClassLoaderUtil.class.getClassLoader();
            if (null == classLoader) {
     ...
     * @param name 类名
     * @return 类名对应的类
     * @throws DggUtilException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(final String name) throws DggUtilException {
     ...
     * @throws DggUtilException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(final String name, final boolean isInitialized) throws DggUtilException {
     ...
     * @throws DggUtilException 包装{@link ClassNotFoundException}，没有类名对应的类时抛出此异常
     */
    public static Class<?> loadClass(final String name, ClassLoader classLoader, final boolean isInitialized) throws DggUtilException {
